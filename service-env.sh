...
mainnet)
  ...
  SOSH_EXPECTED_SHRED_VERSION=50093
...
testnet)
  ...
  SOSH_EXPECTED_SHRED_VERSION=61807

  #SOSH_EXPECTED_BANK_HASH=vBGkhejJQ2RhzsWqwGWS5j7Bb8itKPtbE3rvgP6cw3f
  #SOSH_WAIT_FOR_SUPERMAJORITY=185856928
